 ...
 * Copyright (c) 2009-2011 by truyen, Inc. All Rights Reserved.
...
//@interface truyenObject : NSObject
//@end

@interface truyenObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[truyenObject class]])
		{
			for (NSString *key in [[(truyenObject*)o modules] allKeys])
			{
