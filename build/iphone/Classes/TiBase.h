...
// in simulator we redefine to format for truyen Developer console
...
{\
	NSString * exceptionName = [@"org.truyen." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.truyen";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UItruyenNativeItemNone = -1, 
	UItruyenNativeItemSpinner = -2,
	UItruyenNativeItemProgressBar = -3,
	
	UItruyenNativeItemSlider = -4,
	UItruyenNativeItemSwitch = -5,
	UItruyenNativeItemMultiButton = -6,
	UItruyenNativeItemSegmented = -7,
	
	UItruyenNativeItemTextView = -8,
	UItruyenNativeItemTextField = -9,
	UItruyenNativeItemSearchBar = -10,
	
	UItruyenNativeItemPicker = -11,
	UItruyenNativeItemDatePicker = -12,
	
	UItruyenNativeItemInfoLight = -13,
	UItruyenNativeItemInfoDark = -14,
	
	UItruyenNativeItemDisclosure = -15,
	
	UItruyenNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all truyen instances of
